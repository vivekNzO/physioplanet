...
export default function NewCustomerRegistration() {
  ...
  return (
    <div style={{
      ...
      <div className='w-full mx-auto' style={{ maxWidth: 'calc(100% - 212px)' }}>
        <div style={{ maxWidth: '660px' }}>
          ...
          <h3 className='font-medium text-base mb-[14px]'>New Customer Information</h3>
          ...
          <div style={{
            ...
            background: 'linear-gradient(#FAFAFC 0%, rgba(250,250,252,0.7) 100%)',
            marginBottom: '31px'
          }}>
            <div style={{
              display: 'flex',
              ...
              <div style={{
                ...
                <div style={{
                  ...
                  <div className='w-full flex flex-col gap-[10px]'>
                    <label className='text-[#0D0D0D] text-sm font-normal '>
                      Full Name *
                    </label>
                    <input
                      type='text'
 ...
 '
                    ...
                    <div className='flex flex-col w-1/2 gap-[10px] color-[#0d0d0d] text-sm' >
                      ...
                      <select
                        ...
                        className={`w-full h-[51px] px-[21px] rounded-[4px] border border-[#E9EAEB] bg-white font-poppins text-[14px] outline-none cursor-pointer ${gender ? "text-[#0D0D0D] opacity-100" : "text-[#697079] opacity-66"}
  `}
                      >
